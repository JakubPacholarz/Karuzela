    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Kup lub Sprzedaj</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#!">Informacje</a></li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#!">Dom i ogród</a></li>
                                <li><a class="dropdown-item" href="#!">Supermarket</a></li>
                                <li><a class="dropdown-item" href="#!">Dziecko</a></li>
                                <li><a class="dropdown-item" href="#!">Uroda</a></li>
                                <li><a class="dropdown-item" href="#!">Zdrowie</a></li>
                                <li><a class="dropdown-item" href="#!">Kultura i rozrywka</a></li>
                                <li><a class="dropdown-item" href="#!">Sport i turystyka</a></li>
                                <li><a class="dropdown-item" href="#!">Motoryzacja</a></li>
                                <li><a class="dropdown-item" href="#!">Nieruchomości</a></li>
                                <li><a class="dropdown-item" href="#!">Kolekcje i sztuka</a></li>
                                <li><a class="dropdown-item" href="#!">Firma i usługi</a></li>
                            </ul>
                        </li>
                    </ul>
                    <form class="d-flex">
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">Kup</a></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
