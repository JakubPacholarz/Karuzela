        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('info') }}">Informacje</a></li>
                ...
                <form class="d-flex">
                    <div class="me-2">
                        <a class="btn btn-outline-dark" href="{{ route('login') }}">Zaloguj</a>
                    </div>
                    <div class="me-2">
                        <a class="btn btn-outline-dark" href="{{ route('register') }}">Zarejestruj</a>
                    </div>
                </form>
            </div>
        </div>
